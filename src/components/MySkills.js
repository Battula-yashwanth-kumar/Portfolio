...
const backendSkills = [
  ...
  {id:2,tech:"Spring Boot", icon:<SiSpringboot />},
  {id:3, tech:"Flask", icon:<SiFlask />},
  { id: 4, tech: "MongoDB", icon: <SiMongodb /> },
  { id: 5, tech: "PostgreSQL", icon: <BiLogoPostgresql /> },
  { id: 6, tech: "MySQL", icon: <SiMysql /> },
  { id: 7, tech: "GraphQL", icon: <SiGraphql /> },
  { id: 8, tech: "REST APIs", icon: <AiOutlineApi /> },
...
const devOpsSkills = [
  ...
  { id: 3, tech: "AWS", icon: <SiAmazonaws /> },
  {id:4,tech:"Figma",icon:<SiFigma />},
